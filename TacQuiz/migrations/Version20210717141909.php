 ...
 */
final class Version20210717141909 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE quiz DROP first_name, DROP last_name, DROP cin, DROP email');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE quiz DROP FOREIGN KEY FK_A412FA9212469DE2');
        $this->addSql('ALTER TABLE quiz DROP FOREIGN KEY FK_A412FA92A76ED395');
        $this->addSql('ALTER TABLE quiz ADD first_name TINYINT(1) DEFAULT NULL, ADD last_name TINYINT(1) DEFAULT NULL, ADD cin TINYINT(1) DEFAULT NULL, ADD email TINYINT(1) DEFAULT NULL');
